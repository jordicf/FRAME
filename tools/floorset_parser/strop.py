...
"""
This module manipulates Single-Trunk Orthogonal Polygons (STrOP).
...
class StropInstance:
    ...
    def __str__(self) -> str:
        ...
        The string represents a grid in which 0 represents the trunk
         and 1, 2, ... represent the branches."""
